...
let config = generateConfig(
    ...
    html(),
    less({ filename: 'styles.css', allChunks: false, sourceMap: ENV === 'development' }),
    css({ filename: 'styles.css', allChunks: true, sourceMap: ENV === 'development' }),
    fontAndImages(),
    globalBluebird(),
    globalJquery(),
